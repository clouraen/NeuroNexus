...
pub async fn seed_knowledge_trails(
    ...
    let trails = vec![
        KnowledgeTrail {
            ...
            modules: vec![
                TrailModule {
                    id: Uuid::parse_str("b0000000-0000-0000-0000-000000000010").unwrap(),
                    title: "Fundamentos da Matemática".to_string(),
                    description: "Conceitos básicos: operações, frações, potências e raízes".to_string(),
                    content_type: ContentType::Reading,
                    content_id: Uuid::parse_str("00000000-0000-0000-0000-000000000301").unwrap(),
                    order: 0,
                    completed: false,
                },
                TrailModule {
                ...
                TrailModule {
                    id: Uuid::parse_str("b0000000-0000-0000-0000-000000000013").unwrap(),
                    title: "Álgebra Avançada".to_string(),
                    description: "Sistemas lineares e equações avançadas".to_string(),
                    content_type: ContentType::Reading,
                    content_id: Uuid::parse_str("00000000-0000-0000-0000-000000000302").unwrap(),
                    order: 3,
                    completed: false,
                },
                TrailModule {
                    id: Uuid::parse_str("b0000000-0000-0000-0000-000000000014").unwrap(),
                    title: "Logaritmos".to_string(),
                    description: "Propriedades e aplicações de logaritmos".to_string(),
                    content_type: ContentType::Question,
                    content_id: Uuid::parse_str("10000000-0000-0000-0000-000000000003").unwrap(),
                    order: 4,
                    completed: false,
                },
            ],
        ...
        KnowledgeTrail {
            ...
            modules: vec![
                TrailModule {
                    id: Uuid::parse_str("b0000000-0000-0000-0000-000000000030").unwrap(),
                    title: "Introdução à Física - Mecânica".to_string(),
                    description: "Conceitos de cinemática, dinâmica e leis de Newton".to_string(),
                    content_type: ContentType::Reading,
                    content_id: Uuid::parse_str("00000000-0000-0000-0000-000000000305").unwrap(),
                    order: 0,
                    completed: false,
                },
                TrailModule {
                ...
                TrailModule {
                    id: Uuid::parse_str("b0000000-0000-0000-0000-000000000032").unwrap(),
                    title: "Eletricidade".to_string(),
                    description: "Capacitores e circuitos elétricos".to_string(),
                    content_type: ContentType::Question,
                    content_id: Uuid::parse_str("30000000-0000-0000-0000-000000000002").unwrap(),
                    order: 2,
                    completed: false,
                },
            ],
